  ...
  return (
    <ImageBackground style={{top:-20}} blurRadius={18}source={require("../assets/bg1.jpg")}>
     <View style={{backgroundColor:"",height:320,top:-20}}>
        ...
        <Text style={{fontSize:18,color:"white",top:65,left:30}}>Do-it-together,{'\n'}live on zoom</Text>
        <Text style={{fontSize:18,color:"white",top:20,left:175}}>4.8/5{'\n'}Rated Classes</Text>
        <Text style={{fontSize:18,color:"white",top:-27,left:330}}>35000+{'\n'}Members</Text>
